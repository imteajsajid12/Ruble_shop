...
class SellController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if (!is_null($save)) {
                $data_quantity = $save->product_quantity + $request->quantity;
                $save->product_quantity = $data_quantity;
                $save->save();
                ...
                $this->data['discount']                 = $request->input('discount');
                $value = $request->sell_price * $request->quantity;
            ...
            return response()->json(['danger' => 'You have  danger.']);
        }
    }
